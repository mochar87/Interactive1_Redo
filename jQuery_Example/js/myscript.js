setInterval(function() { 
        $('body')
          ...
          .animate({ backgroundColor: "#80FF00" }, 300);
    },100);
...
$(function() {
       ...
       $( ".ui-draggable" ).draggable().css({"position":"absolute","top":"0px" });;
        ...
        $(function(){
          $.okvideo({ source: 'https://www.youtube.com/watch?v=D79peD6i-rw',
                    volume: 100})
        });
  ...
  function randomNum(t, l) {
    return {
      top: Math.floor(Math.random() * (t + 1)),
